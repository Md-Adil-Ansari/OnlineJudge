...
function UpdateTask() {
  ...
  return (
    <>
      <Navbar />
      <form onSubmit={updateTask} className="flex flex-col items-center justify-center min-h-screen bg-[#1a1a1a]  ">
        <h1 className="mb-5 text-3xl font-bold text-gray-100">Update Problem</h1>
        <div className="w-full max-w-[50rem]">
          ...
          <div className="mb-6 bg-gray-800 rounded shadow p-4">
            ...
            <div className="w-full px-3">
              <textarea
                className="w-full px-4 py-2 leading-tight text-white bg-gray-800 border-2 border-gray-200 rounded appearance-none focus:outline-none focus:bg-gray-800 focus:border-yellow-500"
                placeholder="Name"
                value={data.name}
              ...
              <div key={testcaseIndex} className="w-full px-3 mb-6 bg-gray-200 rounded shadow p-4">
                ...
                {testcase.input.map((input, index) => (
                  <div className="w-full px-3 mb-3">
                    <textarea
                      className="w-full px-4 py-3 leading-tight text-white bg-gray-800 border-2 border-gray-200 rounded appearance-none focus:outline-none focus:bg-gray-800 focus:border-yellow-500"
                      key={index}
          ...
          <div className="mb-6 bg-gray-800 rounded shadow p-4">
            <h2 className="w-full px-3 mb-3 text-1xl font-bold text-white">Time Limit (in seconds)</h2>
            <div className="w-full px-3">
              <textarea
                className="w-full px-4 py-2 leading-tight text-white bg-gray-800 border-2 border-gray-200 rounded appearance-none focus:outline-none focus:bg-gray-800 focus:border-yellow-500"
