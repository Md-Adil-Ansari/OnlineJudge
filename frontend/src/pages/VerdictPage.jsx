...
function VerdictPage() {
  ...
  return (
    <>
      <Navbar />
      <div className="container mx-auto px-4 md:px-8 lg:px-16 xl:px-32 bg-gray-950 ">
        <h1 className="text-4xl font-bold text-center my-8 text-white">VerdictPage</h1>
        <hr className="border-2 border-gray-200 mb-8" />
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          <div>
            <h2 className="text-3xl font-bold mb-4 text-white">Source Code</h2>
          ...
          <div>
            <h2 className="text-3xl font-bold mb-4 text-white">Submission Info</h2>
