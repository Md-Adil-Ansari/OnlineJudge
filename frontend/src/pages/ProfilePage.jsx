...
function ProfilePage() {
    ...
    return (
        <>
            <Navbar />
            <div className="flex flex-col md:flex-row items-start p-4 md:p-10 bg-gray-950 text-white">
                <div className="mb-4 md:mb-0 md:mr-4 w-full md:w-1/4">
                    ...
                    <button onClick={handleUpdateImage} className="mt-2 w-full px-3 py-2 text-white rounded-md bg-gradient-to-r from-yellow-500 to-yellow-700 hover:from-yellow-600 hover:to-yellow-800">Update</button>
                </div>
                <div className="w-full md:w-3/4">
                    ...
                    <div className="flex items-center">
                        <Link className="bg-gradient-to-r from-yellow-500 to-yellow-700 hover:from-yellow-600 hover:to-yellow-800 text-white font-semibold py-2 px-4 rounded-full shadow-md transition duration-300 transform hover:scale-105"
                            to={`/admin`}
                        >
                            AdminPanel
                        </Link>
                    ...
                    <div className="mt-4">
                        <div className="mt-4 p-4 border border-gray-200 rounded bg-gray-800">
                            <CalendarHeatmap
