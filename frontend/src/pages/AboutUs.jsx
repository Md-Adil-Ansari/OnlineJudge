...
const AboutUs = () => {
  return (
    <div className="p-32 font-sans text-white bg-[#1a1a1a]  ">
      <h1 className="text-4xl font-bold mb-5">About Us</h1>
      
      <section>
        <h2 className="text-2xl font-semibold mb-3">Welcome to <strong className="font-bold">Adcoders</strong> – your ultimate destination for honing algorithmic skills and acing coding challenges!</h2>
        
        <h3 className="text-xl font-semibold mb-2">Who I Am</h3>
        <p className="mb-3">Adcoders is a cutting-edge online judge platform dedicated to helping programmers of all levels improve their problem-solving abilities. Whether you're a beginner taking your first steps in coding or an experienced developer looking to sharpen your skills, Adcoders provides the perfect arena for you to practice, compete, and grow.
          Adcoders was pioneered by Md Adil Ansari, a B.Tech. student from IIT Patna, who is passionate about coding and education. With a vision to create a platform that would inspire and empower coders to reach their full potential, Md Adil Ansari is committed to providing a world-class learning experience for all users.
        </p>
        
        <h3 className="text-xl font-semibold mb-2">My Mission</h3>
        <p className="mb-2">At Adcoders, my mission is to:</p>
        ...
        <h3 className="text-xl font-semibold mb-2">Why Choose Adcoders?</h3>
        <ul className="list-disc list-inside mb-3">
        ...
        <p className="mb-3">Whether you're preparing for coding interviews, participating in competitive programming, or simply looking to enhance your algorithmic thinking, Adcoders is the place for you. Join me today and become part of a dynamic community of passionate coders.</p>
        
        <h3 className="text-xl font-semibold mb-2">Contact Me</h3>
        <p className="mb-3">Have questions or need assistance? Reach out to me at <a href="mailto:ad930478441@gmail.com" className="text-yellow-500 hover:text-yellow-700">support@adcoders.com</a>. I'm here to help!</p>
      </section>
